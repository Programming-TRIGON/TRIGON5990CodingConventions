...
For `SubsystemConstants` files, follow this specific logical order:
...
- **Local Finals:** Any local variable inside a method that *can* be final *must* be marked as `final`. This includes variables that store the result of a calculation.
